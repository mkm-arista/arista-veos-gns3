...
* Download the latest **vEOS-lab image in .qcow2** file format, along with the latest **Aboot-veos-<$version>.iso** found under **'vEOS Lab'** here:
    <https://www.arista.com/en/support/software-download>

* Copy both files to the GNS3 host system. If you installed OpenSSH-server, then you can do this simply using the following command:
